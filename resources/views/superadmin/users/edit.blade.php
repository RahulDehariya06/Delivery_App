            ...
            <div class="col-12">
               <div class="card-box">
                  ...
                  <div class="row">
                     <div class="col-sm-4">
                        <div class="sp-wrap">
                           <form class="form-horizontal" method="post" action="{{url('superAdmin/users/updateimage')}}" enctype="multipart/form-data" id="profileupdate">
                              @csrf
                              ...
                              @endif
                              <input class="profile-photo" type="file" name="file" id="updatephoto" data-id="{{$profile->user_id}}">
                        </div>
                        </form>
                     </div>
                     <div class="col-12">
                        <div class="p-20">
                           <form class="form-horizontal" method="post" action="{{url('superAdmin/users/update')}}" enctype="multipart/form-data">
                              @csrf
                              ...
                              <input type="hidden" name="address_id" id="address_id" value="{{$profile->address_id}}">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-10">
                                    <select class="custom-select " name="status">
                                       ...
                                       <option  value="0" {{ $profile->user_status == 0  ? 'selected' : ''}} >In-active</option>
                                    </select>
                                    @error('file')
                                    <p class="error">{{ $message }}</p>
                                    @enderror
